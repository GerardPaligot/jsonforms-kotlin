...
internal class RendererLayoutScopeInstance(
    ...
    override fun description(): String? =
        if (uiSchema is GroupLayout) uiSchema.description else null

    override fun elements(): List<UiSchema> = uiSchema.elements?.toList() ?: emptyList()

    override fun verticalSpacing(): String? = when (uiSchema) {
    ...
    override fun horizontalSpacing(): String? = when (uiSchema) {
